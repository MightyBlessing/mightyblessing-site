    ...
    <section className="overflow-hidden bg-[#F8F9FB] py-24 dark:bg-[#0F0F12]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 flex items-end justify-between">
          <h2 className="text-3xl font-black text-[#111111] dark:text-white md:text-4xl">Featured Portfolio</h2>
          <Link href="/portfolio" className="text-sm font-bold text-[#6A00FF] hover:underline">
            전체 보기
          </Link>
        </div>
